...
import static uk.gov.hmcts.reform.wataskconfigurationapi.services.PermissionsService.WA_TASK_PERMISSIONS_DECISION_TABLE_NAME;
...
class PermissionsServiceTest {
    ...
    @BeforeEach
    void setUp() {
        permissionsService = new PermissionsService(camundaServiceApi, authTokenGenerator);
    }
